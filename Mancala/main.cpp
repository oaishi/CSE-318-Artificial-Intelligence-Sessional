...
int main()
{
    ...
    while (!board.gameFinish())
    {
        ...
        if (human.getTurn() == true)
        {
            ...
            int pitno;
            human.SelectTurn(pitno, Player::HUMAN, board, Player::ALPHABETA,heus,INT_MAX, INT_MIN);
        ...
        else if (cpu.getTurn() == true)
        {
            ...
            cpu.SelectTurn(pitno, Player::CPU, board, Player::ALPHABETA,heus1,INT_MAX, INT_MIN);
